...
#fungsi ini untuk inisialisasi LLM yang dipakai menggunakan OPENROUTER. LLM akan dipakai untuk menjawab pertanyaan serta memproses pertanyaan typo, ambigu, dan tidak objek dalam pertanyaan
